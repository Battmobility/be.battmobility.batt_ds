                ...
                Padding(
                  ...
                  child: Wrap(
                      ...
                      children: [
                        ...
                        BattSquareChip(
                          label: "Enabled medium with a long text expanded",
                          onSelected: (_) => {},
                          chipSize: BattChipSize.medium,
                          expand: true,
                          state: BattChipState.enabled,
                        ...
                        BattSquareChip(
                          label:
                              "Enabled medium with a really stupendously long text that will overflow the screen expanded",
                          onSelected: (_) => {},
                          expand: true,
                          chipSize: BattChipSize.medium,
                          state: BattChipState.enabled,
