...
class AppInputTheme extends ThemeExtension<AppInputTheme> {
  ...
  factory AppInputTheme.light() {
    return AppInputTheme(
      defaultText: AppColors.primaryColors[500]!,
      focusedOnBrand: AppColors.primaryColors[900]!,
      focusedTextDefault: AppColors.primaryColors[900]!,
      errorTextDefault: AppColors.errorText,
      successTextDefault: AppColors.success,
      disabledText: AppColors.grey[300]!,
      borderDefault: AppColors.primaryColors[500]!,
      borderHover: AppColors.primaryColors[400]!,
      borderFocused: AppColors.primaryColors[500]!,
  ...
  factory AppInputTheme.dark() {
    return AppInputTheme(
      ...
      disabledText: AppColors.grey[300]!,
      borderDefault: AppColors.primaryColors[500]!,
      borderHover: AppColors.primaryColors[100]!,
      borderFocused: AppColors.primaryColors[500]!,
      borderError: AppColors.error,
      borderSuccess: AppColors.success,
      borderDisabled: AppColors.grey[300]!,
