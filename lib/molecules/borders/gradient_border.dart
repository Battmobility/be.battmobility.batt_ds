...
class GradientOutlineInputBorder extends InputBorder {
  const GradientOutlineInputBorder({
    ...
    this.width = 1.0,
    this.gapPadding = AppSpacings.sm,
    this.borderRadius = CornerRadii.s,
  });
  ...
  Path getOuterPath(Rect rect, {TextDirection? textDirection}) {
    return Path()
      ..addRRect(
          BorderRadius.all(borderRadius).resolve(textDirection).toRRect(rect));
  }
  ...
  void paint(
    ...
    final outer = BorderRadius.all(borderRadius).toRRect(rect);
